...
- Computing is part of God's world — it reveals wisdom in creation and enables scientific study
- Problem decomposition develops intellectual virtue
- Automation enables human flourishing
- It's a creative and rewarding process
- It's useful across disciplines

**Fall:**

- Centralization into few powerful actors harms cultural diversity
- It alienates people from God's created order
- It gets misused for financial gain
- It's constantly idolized
...
- Design data types/structures and algorithms that solve problems
- Implement solutions using primitive data types, expressions, and basic control structures (sequence, selection, repetition)
- Find and fix syntactic and logical problems in programs
- Use an Integrated Development Environment (IDE) to develop programs
- Articulate a reformed perspective on perspectival issues in computing

### Topics Schedule

| Week | Topic |
|------|-------|
| 1 | [Introduction](/weeks/#week-1) |
| 2 | [Operators](/weeks/#week-2) |
| 3 | [Data Types](/weeks/#week-3) |
| 4 | [Conditionals](/weeks/#week-4) |
| 5 | [Loops](/weeks/#week-5) |
| 6 | [Functions](/weeks/#week-6) |
| 7 | [Modules](/weeks/#week-7) |
...
- **Can't pay right away?** request a deferral by following [these instructions](https://support.zybooks.com/hc/en-us/articles/360007439574-Does-zyBooks-offer-temporary-subscriptions); email the instructor if you need further help
- Reading, lab, and homework assignments match the unit preparation pages (Assignments tab, bottom right of the textbook page)
- **After the course ends:** the interactive text becomes inaccessible. You can purchase a short-term extension, or [print a PDF version](https://zybooks.zendesk.com/hc/en-us/articles/360007537533-How-long-do-subscriptions-last-Can-I-extend-Can-I-save-or-print-) of each chapter as a non-interactive reference beforehand

**Additional readings:**

- [Technology and the Biblical Story](https://digitalcollections.dordt.edu/cgi/viewcontent.cgi?article=2949&context=pro_rege), D. Schuurman, *Pro Rege*, 46(1), 2017
- [*Activities for CS1 in Python*](https://cs.calvin.edu/courses/cs/108/26sp/resources/pogil/Activities%20for%20CS1%20in%20Python%20-%20Student.pdf), T. Shepherd, C. Mayfield & H. Hu, Creative Commons

**Development environment:** [Thonny](https://thonny.org/) (installed on lab computers) or [Calvin's Coder service](https://coder.cs.calvin.edu/workspaces), which requires no local installation. See [Resources](/resources/) for details.
...
- The due dates on assignments are designed to keep you on track. It is quite difficult to "catch up."
- Quizzes can be made up only for documented exceptional circumstances, arranged in advance if possible.

## Study Sessions {#study-sessions}

Study sessions are a great way to stay on track:

- A supervised place to do homework and ask questions
- A room full of people working through similar challenges
...
### Technology in Class {#technology-in-class}
...
Studies show that [internet-enabled electronic devices in the classroom reduce student performance](https://www.insidehighered.com/news/2018/07/27/class-cellphone-and-laptop-use-lowers-exam-scores-new-study-shows), even for those who don't use devices themselves, because of distraction.

Rather than banning devices, this course practices using technology **within limits**:

- Use smartphones/laptops for completing retrieval quizzes and polls during designated times
- Use laptops for taking notes or attempting programming tasks as directed
- Beyond those uses, technology use in class is limited to critical messages only
...
- One partner submits one copy with both names and email addresses
- It's wise for both partners to keep a copy of the shared solution
- Note: Outlook blocks `.py` attachments. Workarounds include using OneDrive, renaming the file to `.txt`, or making a `.zip` file ("compressed folder")
...
### Academic Integrity in Computing {#academic-integrity-in-computing}
